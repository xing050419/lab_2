  ...
  <body>
    ...
    <div class="container" style="padding-top: 20px">
      <ul class="nav nav-pills nav-fill">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="searchbookrequest?">查询图书</a>
        </li>
        <li class="nav-item">
      ...
      <div class="card">
        <div class="card-header">输入书名或ISBN</div>
        <div class="card-body">
          <form action="searchbook">
            <div class="form-group row">
              <label for="searchKey" class="col-sm-2 col-form-label">关键字</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="searchKey" placeholder="请输入书名或ISBN" name="key">
                <small id="isbnHelp" class="form-text text-muted">ISBN由17位数字与“-”组成，例：978-7-115-12345-6</small>
              </div>
            </div>
