...
<html lang="zh-cn">
  ...
  <body>
    ...
    <div class="container" style="padding-top: 20px">
      ...
      <div class="card">
        <div class="card-header">输入更新信息</div>
        <div class="card-body">
          <form action="update">
            <div class="form-group row">
              <label for="bookIsbn" class="col-sm-2 col-form-label">ISBN</label>
              <div class="col-sm-10">
                <input type="text" readonly class="form-control-plaintext" id="bookIsbn" value="<s:property value="isbn"/>" name="isbn"/>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="bookPublisher" placeholder="请输入出版社" name="publisher">
              </div>
            </div>
            <div class="form-group row">
